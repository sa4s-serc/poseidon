...
avg_inference_times_criticality = []
avg_inference_times_vsvbp = []
avg_inference_times_poseidon_zero = []
avg_inference_times_poseidon_one = []
avg_inference_times_neptune_zero = []
avg_inference_times_neptune_one = []
...
def plot_bar_delay(vsvbp_delay, poseidon_delay_zero, poseidon_delay_one, neptune_delay_zero, neptune_delay_one, criticality_results, title, bar_color="#9ED2BE"):
    ...
    sns.barplot(x='Solver', y='Delay', data=data, ax=ax, palette='dark:#69d')

    # Customizing the plot
    ax.set_title(title, fontsize=16, fontweight='bold', color=text_color)
    ax.set_xlabel('Solver', fontsize=12, color=text_color)
    ax.set_ylabel('Delay', fontsize=12, color=text_color)
    ...
    for i, v in enumerate(delays):
        ax.text(i, v, f'{v:.2f}', ha='center', va='bottom', fontsize=10, color=text_color)
...
avg_inference_time_criticality = 0
avg_inference_time_vsvbp = 0
avg_inference_time_poseidon_zero = 0
avg_inference_time_neptune_zero = 0
avg_inference_time_poseidon_one = 0
avg_inference_time_neptune_one = 0
...
if input("Inference?") == "y":
    ...
    for _ in range(151):
        ...
        # avg_inference_time_criticality += criticality_results[2][0]
        ...
        # avg_inference_times_criticality.append(criticality_results[2][0])
        ...
        # avg_inference_time_poseidon_zero += poseidon_results_zero[2][0]
        ...
        # avg_inference_times_poseidon_zero.append(poseidon_results_zero[2][0])
        ...
        avg_inference_time_poseidon_one += poseidon_results_one[2][0]
        ...
        avg_inference_times_poseidon_one.append(poseidon_results_one[2][0])
        ...
        # avg_inference_time_neptune_zero += neptune_results_zero[2][0]
        ...
        # avg_inference_times_neptune_zero.append(neptune_results_zero[2][0])
        ...
        avg_inference_time_neptune_one += neptune_results_one[2][0]
        ...
        avg_inference_times_neptune_one.append(neptune_results_one[2][0])

        if _ % 10 == 0:
            with open(f'results_{_}.pkl', 'wb') as f:
                pickle.dump([avg_delay_criticality, avg_delay_vsvbp, avg_delay_poseidon_zero, avg_delay_poseidon_one, avg_delay_neptune_zero, avg_delay_neptune_one, avg_inference_time_criticality,
                            avg_inference_time_vsvbp, avg_inference_time_poseidon_zero,avg_inference_time_poseidon_one, avg_inference_time_neptune_zero,avg_inference_time_neptune_one, avg_cost_criticality, avg_cost_vsvbp, avg_cost_poseidon_zero,avg_cost_poseidon_one,avg_cost_neptune_zero, avg_cost_neptune_one], f)

            with open(f'results_cumulative_{_}.pkl', 'wb') as f:
                pickle.dump([avg_delays_criticality, avg_delays_vsvbp, avg_delays_poseidon_zero, avg_delays_poseidon_one, avg_delays_neptune_zero, avg_delays_neptune_one, avg_costs_criticality, avg_costs_vsvbp, avg_costs_poseidon_zero, avg_costs_poseidon_one, avg_costs_neptune_zero, avg_costs_neptune_one, avg_inference_times_criticality, avg_inference_times_vsvbp, avg_inference_times_poseidon_zero, avg_inference_times_poseidon_one, avg_inference_times_neptune_zero, avg_inference_times_neptune_one], f)
    ...
    avg_inference_time_criticality /= 150
    avg_inference_time_vsvbp /= 150
    avg_inference_time_poseidon_zero /= 150
    avg_inference_time_neptune_zero /= 150
    avg_inference_time_poseidon_one /= 150
    avg_inference_time_neptune_one /= 150
    ...
    plot_bar_delay(avg_inference_time_vsvbp, avg_inference_time_poseidon_zero, avg_inference_time_poseidon_one, avg_inference_time_neptune_zero,
                   avg_inference_time_neptune_one, avg_inference_time_criticality, "Criticality vs VSVBP vs Poseidon vs Neptune Average Inference Time")
else:
    with open("results_120.pkl", "rb") as f:
        result = pickle.load(f)

    avg_delay_criticality, avg_delay_vsvbp, avg_delay_poseidon_zero, avg_delay_poseidon_one, avg_delay_neptune_zero, avg_delay_neptune_one, avg_inference_time_criticality, avg_inference_time_vsvbp, avg_inference_time_poseidon_zero, avg_inference_time_poseidon_one, avg_inference_time_neptune_zero, avg_inference_time_neptune_one, avg_cost_criticality, avg_cost_vsvbp, avg_cost_poseidon_zero, avg_cost_poseidon_one, avg_cost_neptune_zero, avg_cost_neptune_one = result

    avg_delay_criticality /= 120
    avg_delay_vsvbp /= 120
    avg_delay_poseidon_zero /= 120
    avg_delay_neptune_zero /= 120
    avg_delay_poseidon_one /= 120
    avg_delay_neptune_one /= 120

    avg_inference_time_criticality /= 120
    avg_inference_time_vsvbp /= 120
    avg_inference_time_poseidon_zero /= 120
    avg_inference_time_neptune_zero /= 120
    avg_inference_time_poseidon_one /= 120
    avg_inference_time_neptune_one /= 120

    avg_cost_criticality /= 120
    avg_cost_vsvbp /= 120
    avg_cost_poseidon_zero /= 120
    avg_cost_neptune_zero /= 120
    avg_cost_poseidon_one /= 120
    avg_cost_neptune_one /= 120
    ...
    plot_bar_delay(avg_inference_time_vsvbp, avg_inference_time_poseidon_zero, avg_inference_time_poseidon_one, avg_inference_time_neptune_zero,
                   avg_inference_time_neptune_one, avg_inference_time_criticality, "CR-EUA vs VSVBP vs Poseidon vs Neptune Average Inference Time")
